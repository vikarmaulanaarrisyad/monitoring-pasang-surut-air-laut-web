...
(function (b) {
    ...
    x(
        ...
        function (b, r, q) {
            ...
            function m(a) {
                ...
                let e = "Seconds";
                c.Seconds =
                    ((a.dataMax || a.max || 0) - (a.dataMin || a.min || 0)) /
                    1e3;
                ...
                getChartTitle: function (a) {
                    return g(
                        a.options.title.text ||
                            a.langFormat("accessibility.defaultChartTitle", {
                                chart: a,
                            })
                    );
                },
            ...
            class q {
                ...
                run(b) {
                    ...
                    l
                        ? (q = l[1].call(this, m, b))
                        : 9 === m &&
                          (q = this.response[b.shiftKey ? "prev" : "next"]);
                    return q;
                }
            }
            ("");
                ...
                function k(a, c) {
                    ...
                    this.focusBorder = this.renderer
                        .rect(
                            ...
                            y,
                            h,
                            parseInt(((c && c.r) || 0).toString(), 10) / E
                        )
            ...
            class k {
                ...
                addAnnounceRegion(b) {
                    ...
                    this.chart.styledMode
                        ? v(c, "highcharts-visually-hidden")
                        : z(c);
                    a.appendChild(c);
                    return c;
                }
        ...
        function (b) {
            ...
            return {
                getAnnotationsInfoHTML: function (b) {
                    ...
                    return n && n.length
                        ? `<ul style="list-style-type: none">${m(b).join(
                              " "
                          )}</ul>`
                        : "";
                },
                ...
                getPointAnnotationTexts: function (b) {
                    const n = r(b.series.chart).filter(
                        (k) => -1 < k.points.indexOf(b)
                    );
        ...
        function (b, r, q, l, m, u, L, z, n, k) {
            function g(a, b) {
                    ...
                    );
                {
                    ...
                    const d =
                        a.series && 2 > a.series.length ? "Single" : "Multiple";
                    a =
            ...
            class t extends r {
                ...
                updateScreenReaderSection(a) {
                    const b = this.chart,
                        ...
                        d = c.buildContent(b),
                        h = (c.element =
                            c.element || this.createElement("div")),
                    ...
                    d
                        ? (this.setScreenReaderSectionAttribs(h, a),
                          ...
                          c.insertIntoDOM(h, b),
                          b.styledMode
                              ? J(p, "highcharts-visually-hidden")
                              : A(p),
                          f(b, p),
    ...
    x(
        ...
        function (b, r, q, l, m, u) {
            ...
            class g extends q {
                ...
                onKbdClick(a) {
                    const b = this.chart,
                        ...
                        e = (b.exportSVGElements && b.exportSVGElements[0])
                            .element;
                    b.openMenu
            ...
            (function (a) {
                ...
                function e(a) {
                    const b =
                            this.exportDivElements && this.exportDivElements[a],
                        c =
        ...
        function (b, r, q, l, m) {
            ...
            class a {
                ...
                init(a, b) {
                    ...
                    c.addEvent(this.tabindexContainer, "focus", (a) =>
                        this.onFocus(a)
                    );
                ...
                onFocus(a) {
                    ...
                    a =
                        a.relatedTarget &&
                        b.container.contains(a.relatedTarget);
                    !(b =
                        (b = b.options.accessibility) &&
        ...
        function (b, r, q, l, m, u, L, z) {
            function n(a) {
                ...
                a =
                    a.colorAxis &&
                    a.colorAxis.some(
                        (a) => !a.dataClasses || !a.dataClasses.length
                    );
            ...
            class G extends m {
                    ...
                    this.addEvent(q, "afterRender", function () {
                        this.chart === a.chart &&
                            ...
                            E(
                                ...
                                g(f(this.chart.renderer.globalAnimation, !0))
                                    .duration
                            );
                    });
                }
                    ...
                    (b.allItems || []).forEach((h) => {
                        if (h.a11yProxyElement) {
                            ...
                            e &&
                                ...
                                (e = f.y || 0),
                                (p = f.label
                                    ? Math.round(f.label.getBBox().height)
                                    : 0),
                ...
                proxyLegendItem(a) {
                    ...
                    if (b.label && b.group) {
                        var c = this.chart.langFormat(
                            "accessibility.legend.legendItem",
                            { chart: this.chart, itemName: v(a.name), item: a }
                        );
                        a.a11yProxyElement = this.proxyProvider.addProxyElement(
                            "legend",
                            {
                                click: b.label,
                                visual: (b.group.div ? b.label : b.group)
                                    .element,
                            },
                            {
                                tabindex: -1,
                ...
                function b(a) {
                    ...
                    return h
                        ? (e(c) && b[c] && k(!1, b[c]),
                          ...
                          (a =
                              h.a11yProxyElement &&
                              h.a11yProxyElement.buttonElement),
        ...
        function (b, r, q, l, m) {
            ...
            function d(a) {
                ...
                if (d) {
                    ...
                    var t = p.chart;
                    var C =
                            (p.options.accessibility &&
                                p.options.accessibility.point) ||
                            {},
                    ...
                    a.points.forEach((c) => {
                        ...
                        if (!(e = c.graphic && c.graphic.element)) {
                            ...
                            if ((e = c.isNull && !p && e)) {
                                ...
                                t = c.series.chart.renderer.rect(
                                    t.x,
                                    t.y,
                                    1,
                                    1
                        ...
                        if (e)
                            if (c.isNull && !f)
                                ...
                                p = c.series;
                                t =
                                    (null === (w = p.options.accessibility) ||
                                    void 0 === w
                                        ? void 0
                                        : w.point) || {};
            ...
            function f(b) {
                ...
                C =
                    c.langFormat(
                        "accessibility.series.summary." + b.type + h,
                        C
                    ) ||
                ...
                p = H(
                    b.options.accessibility &&
                        b.options.accessibility.descriptionFormat,
                ...
                describeSeries: function (a) {
                    ...
                    if (d) {
                        ...
                        x(b, d);
                        {
                            ...
                            c = 1 < p.series.length;
                            p =
                                p.options.accessibility.series
                                    .describeSingleSeries;
                            const h = (a.options.accessibility || {})
                                .exposeAsGroupOnly;
                            b =
            ...
            class d {
                ...
                onSeriesAdded(a) {
                    this.chart.options.accessibility.announceNewData.enabled &&
                        ...
                        (this.dirty.newSeries = k(this.dirty.newSeries)
                            ? void 0
                            : a));
                }
                announceDirtyData() {
            ...
            (function (a) {
                function b(a) {
                    ...
                    c &&
                        ...
                        (c.dirty.newPoint = k(c.dirty.newPoint)
                            ? void 0
                            : a.point);
                }
                function c() {
        ...
        function (b, r, q, l, m, u) {
            ...
            class c {
                ...
                clearGroup(b) {
                    ...
                    if (!c)
                        throw Error(
                            "ProxyProvider.clearGroup: Invalid group key " + b
                        );
        ...
        function (b, r, q) {
            function l() {
                ...
                f <= w &&
                    ...
                    (this.newMax = Math.min(
                        f + g,
                        I(this.dataMax, Number.MAX_VALUE)
                    )));
                B(c)
                    ? !B(a) && a && a._offsetMin && (f += a._offsetMin)
                    : (f = void 0);
                return f;
            }
            function m() {
            ...
            function g(a) {
                ...
                d &&
                    ...
                    (b =
                        (b && b.verticalAlign) ||
                        (d.options && d.options.verticalAlign)),
                    d.options.floating ||
                        ("bottom" === b
                            ? (this.extraBottomMargin = !0)
                            : "middle" !== b && (this.extraTopMargin = !0)),
                    this.extraBottomMargin !== a ||
                        this.extraTopMargin !== c) &&
                    (this.isDirtyBox = !0);
            }
            ...
            return {
                compose: function (b, h, e) {
                    ...
                    q.pushUnique(G, c) &&
                        (f(a, { rangeSelector: r.rangeSelector }),
                        f(a.lang, r.lang));
                },
            };
        }
            ...
            class y {
                ...
                clickButton(c, d) {
                    const h = this.chart,
                        ...
                        t = h.xAxis[0];
                    var g =
                            (h.scroller && h.scroller.getUnionExtremes()) ||
                            t ||
                            {},
                        w = e.type;
                        ...
                        if ("month" === w || "year" === w)
                            ...
                            "all" === w &&
                                ...
                                (h.navigator &&
                                    ...
                                    (h.navigator.baseSeries[0].xAxis.options.range =
                                        void 0),
                                (q = y),
                                (D = m));
                ...
                drawInput(a) {
                    ...
                    const y = c.options.rangeSelector,
                        m = "min" === a;
                    var A =
                        z.lang[m ? "rangeSelectorFrom" : "rangeSelectorTo"] ||
                        "";
                    A = n
                        .label(A, 0)
                ...
                render(b, c) {
                    ...
                    if (!1 !== g.enabled) {
                        this.rendered ||
                            ...
                            h.parentNode &&
                                h.parentNode.insertBefore(this.div, h),
                            f &&
                                ((this.inputGroup = e
                                    .g("input-group")
                                    .add(this.group)),
                ...
                handleCollision(a) {
                    ...
                    d && c
                        ? h.align === e.align ||
                          k(this.initialButtonGroupWidth + 20)
                            ? "responsive" === f
    ...
    x(
        ...
        function (b, r, q, l, m, u) {
            const { unhideChartElementFromAT: v, getAxisRangeDescription: z } =
                    q,
                { addEvent: n, attr: k } = u;
            class g extends r {
                constructor() {
                ...
                updateSelectorVisibility() {
                    ...
                    b && b.hasVisibleDropdown && d
                        ? (v(a, d),
                          e.forEach((a) =>
                              a.element.setAttribute("aria-hidden", !0)
                          ))
                ...
                onInputKbdMove(a) {
                    ...
                    if (1 < e || 0 > e) {
                        if (b.accessibility)
                            return (
                                (b.accessibility.keyboardNavigation.exiting =
                                    !0),
            ...
            (function (a) {
                ...
                a.compose = function (a, g) {
                    u.pushUnique(e, a) &&
                        (a.prototype.highlightRangeSelectorButton = c);
        ...
        function (b, r, q, l, m) {
            ...
            class k extends b {
                ...
                onMapKbdTab(b, a) {
                    ...
                    c.mapNavigation.navButtons[
                        this.focusedMapNavButtonIx
                    ].setState(0);
                    if (d)
                        return (
                            c.mapView && c.mapView.zoomBy(),
                            b[a ? "prev" : "next"]
                        );
        ...
        function (b) {
            ...
            return {
                isHighContrastModeActive: function () {
                    ...
                    if (l.matchMedia && b)
                        return l.matchMedia("(-ms-high-contrast: active)")
                            .matches;
                    if (q && l.getComputedStyle) {
                        ...
                        const m = (b.currentStyle || l.getComputedStyle(b))
                            .backgroundImage;
                    ...
                    return (
                        l.matchMedia &&
                        l.matchMedia("(forced-colors: active)").matches
                    );
                },
        ...
        function (
            ...
            class C {
                ...
                initComponents() {
                    ...
                    c.customComponents &&
                        y(this.components, c.customComponents);
                ...
                getComponentOrder() {
                    ...
                    const a = Object.keys(this.components).filter(
                        (a) => "series" !== a
                    );
            ...
            (function (b) {
                ...
                function l() {
                    ...
                    c && c.enabled
                        ? a && !a.zombie
                            ? a.update()
                            : ((this.accessibility = a = new b(this)),
                              !a.zombie) && a.update()
                        : a
