...
<body class="bg-light">
    {{-- Navbar --}}
    <nav class="navbar navbar-expand-sm sticky-top bg-primary navbar-dark border-bottom" style="top: -1px;">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">SIM MONITORING</a>
